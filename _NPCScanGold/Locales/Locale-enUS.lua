...
select( 2, ... ).L = setmetatable( {
	...
	BROKER_CACHED = "Cached",
	BROKER_HINT = "Click to open the options, right click for the NPC list.",
	BROKER_NONE_FOUND = "No rare found yet",
	BROKER_SCANNING = "Scanning",
	BROKER_ZONE_EMPTY = "No known rares in this zone.",
	...
	CONFIG_DESC = "These options let you configure the way _NPCScanGold alerts you when it finds rare NPCs.",
	...
	CONFIG_TITLE = "_|cffFFD700NPCScan Gold|r",
	CONFIG_LIVESCAN = "Alert for rares near you, even if already cached",
	CONFIG_LIVESCAN_DESC = "Watches your target, your mouseover, your group's targets and nearby nameplates for rare mobs.  This doesn't use the client's cache, so it still alerts for rares that were cached before you logged in and can no longer be scanned for.",
	CONFIG_MAPPINS = "Show rare spawn points on the world map",
	CONFIG_MAPPINS_DESC = "Marks the known spawn points of every rare in the database on the world map.  Hover a marker to see the rare's name, level and whether it's already cached.",
	CONFIG_MINIMAPICON = "Show minimap button",
	CONFIG_MINIMAPICON_DESC = "Shows a button next to the minimap listing the rares of your current zone.  The same feed is picked up by Titan Panel and other data broker displays, where you can add or remove it like any other plugin.",
	MAP_PIN_CACHED = "Already cached, can't be scanned for",
	MAP_PIN_LEVEL_FORMAT = "Level %s %s",
	MAP_PIN_TAMABLE = "Tamable",
	...
	PRINT_FORMAT = "_|cffFFD700NPCScan Gold|r: %s",
...
SLASH__NPCSCANGOLD1 = "/npcscan";
SLASH__NPCSCANGOLD2 = "/scan";

BINDING_HEADER__NPCSCANGOLD = "_|cffFFD700NPCScan Gold|r";
_G[ "BINDING_NAME_CLICK _NPCScanGoldButton:LeftButton" ] = [=[Target last found mob
|cff808080(Use when _NPCScanGold alerts you)|r]=];