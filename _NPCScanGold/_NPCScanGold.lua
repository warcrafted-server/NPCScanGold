--[[****************************************************************************
  ...
  * _NPCScanGold.lua - Scans NPCs near you for specific rare NPC IDs.              *
  ****************************************************************************]]
...
do
	local Tooltip = CreateFrame( "GameTooltip", "_NPCScanGoldTooltip" );
...
function me.Frame:PLAYER_LOGIN ( Event )
	...
	local Options = _NPCScanGoldOptions;
	local OptionsCharacter = _NPCScanGoldOptionsCharacter;
	_NPCScanGoldOptions = me.Options;
	_NPCScanGoldOptionsCharacter = me.OptionsCharacter;
...
SlashCmdList[ "_NPCSCANGOLD" ] = me.SlashCommand;