--[[****************************************************************************
  ...
  * _NPCScanGold.Overlays.lua - Integration with NPC map overlay mods.             *
  ****************************************************************************]]


local AddOnName, _NPCScanGold = ...;
local me = LibStub( "AceEvent-3.0" ):Embed( {} );
_NPCScanGold.Overlays = me;
...
--- Announces to overlay mods that _NPCScanGold will take over control of shown paths.
