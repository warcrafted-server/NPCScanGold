...
_NPCScanGold.L = setmetatable( {
	...
	CONFIG_DESC = "_NPCScanGold에서 NPC를 탐색하였을때의 경보 옵션을 설정할 수 있습니다.",
	CONFIG_TEST = "탐색시 경보 테스트",
	CONFIG_TEST_DESC = "탐색시 경보가 어떻게 보여지는지 테스트합니다.",
	CONFIG_TEST_HELP_FORMAT = "Target 버튼을 클릭하거나 _NPCScanGold에 할당해둔 단축키를 눌러 탐색된 NPC를 선택할 수 있습니다. Hold |cffffffff<%s>|r 키를 누른 상태로 Target 버튼을 드래그하여 이동시킬 수 있습니다. 만약 NPC가 전투중에 탐색되었다면, Target버튼은 전투가 끝난 후 활성화 됩니다.",
...
}, { __index = _NPCScanGold.L; } );


_G[ "BINDING_NAME_CLICK _NPCScanGoldButton:LeftButton" ] = [=[마지막으로 탐색된 NPC 타겟
|cff808080(_NPCScanGold에서 탐색이 되어 경보가 되었을 때)|r]=];