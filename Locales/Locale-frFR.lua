...
_NPCScanGold.L = setmetatable( {
	...
	CONFIG_DESC = "Ces options vous permettent de définir comment _NPCScanGold vous prévient quand il trouve un PNJ rare.",
...
_G[ "BINDING_NAME_CLICK _NPCScanGoldButton:LeftButton" ] = [=[Cibler dernier monstre trouvé
|cff808080(Utile qd _NPCScanGold vous alerte)|r]=];